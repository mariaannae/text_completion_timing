...
})({"3PIAf":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "80175face840179b";
"use strict";
...
},{}],"dIQpz":[function(require,module,exports) {
...
async function main() {
    ...
    const model_Smol135 = "SmolLM2-135M-Instruct-q0f32-MLC";
    const appConfig = {
        model_list: [
            {
                model: "https://huggingface.co/mlc-ai/SmolLM2-135M-Instruct-q0f32-MLC",
                model_id: model_Smol135,
                model_lib: _webLlm.modelLibURLPrefix + _webLlm.modelVersion + "/SmolLM2-135M-Instruct-q0f32-ctx4k_cs1k-webgpu.wasm",
                overrides: {
    ...
    const inference_engine = await _webLlm.CreateMLCEngine(model_Smol135, {
        appConfig: appConfig,
...
},{"@mlc-ai/web-llm":"jkSFw"}]},["3PIAf","dIQpz"], "dIQpz", "parcelRequire90c9")

//# sourceMappingURL=SmolLM_135M.e840179b.js.map
