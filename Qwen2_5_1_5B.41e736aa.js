...
})({"gvOxd":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "b6e6de1941e736aa";
"use strict";
...
},{}],"8B9sy":[function(require,module,exports) {
...
async function main() {
    ...
    const model_qwen = "Qwen2.5-1.5B-Instruct-q4f32_1-MLC";
    const appConfig = {
        model_list: [
            {
                model: "https://huggingface.co/mlc-ai/Qwen2.5-1.5B-Instruct-q4f32_1-MLC",
                model_id: model_qwen,
                model_lib: _webLlm.modelLibURLPrefix + _webLlm.modelVersion + "/Qwen2-1.5B-Instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm",
                overrides: {
    ...
    const inference_engine = await _webLlm.CreateMLCEngine(model_qwen, {
        appConfig: appConfig,
...
},{"@mlc-ai/web-llm":"jkSFw"}]},["gvOxd","8B9sy"], "8B9sy", "parcelRequire90c9")

//# sourceMappingURL=Qwen2_5_1_5B.41e736aa.js.map
