...
})({"ccOKd":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "cbaedee1a6b2cc04";
"use strict";
...
},{}],"djjOP":[function(require,module,exports) {
...
async function main() {
    ...
    const model_Smol360 = "SmolLM2-360M-Instruct-q4f32_1-MLC";
    const appConfig = {
        model_list: [
            {
                model: "https://huggingface.co/mlc-ai/SmolLM2-360M-Instruct-q4f32_1-MLC",
                model_id: model_Smol360,
                model_lib: _webLlm.modelLibURLPrefix + _webLlm.modelVersion + "/SmolLM2-360M-Instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm",
                overrides: {
    ...
    const inference_engine = await _webLlm.CreateMLCEngine(model_Smol360, {
        appConfig: appConfig,
...
},{"@mlc-ai/web-llm":"jkSFw"}]},["ccOKd","djjOP"], "djjOP", "parcelRequire90c9")

//# sourceMappingURL=SmolLM_360M.a6b2cc04.js.map
