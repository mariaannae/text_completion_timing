...
})({"cIPoL":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "ec7738d9f9eebc4b";
"use strict";
...
},{}],"lI2HA":[function(require,module,exports) {
...
async function main() {
        ...
        model_list: [
            {
                ...
                model_lib: _webLlm.modelLibURLPrefix + _webLlm.modelVersion + "/stablelm-2-zephyr-1_6b-q4f32_1-ctx4k_cs1k-webgpu.wasm",
                overrides: {
    ...
    const inference_engine = await _webLlm.CreateMLCEngine(model_zephyr, {
        appConfig: appConfig,
...
},{"@mlc-ai/web-llm":"jkSFw"}]},["cIPoL","lI2HA"], "lI2HA", "parcelRequire90c9")

//# sourceMappingURL=StableLM_Zephyr_1_6B.f9eebc4b.js.map
