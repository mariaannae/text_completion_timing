...
})({"eZ0eC":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "233fd016eaa4679b";
"use strict";
...
},{}],"221aX":[function(require,module,exports) {
...
async function main() {
    ...
    const appConfig = {
        model_list: [
            {
                model: "https://huggingface.co/mlc-ai/Llama-3.1-8B-q4f32_1-MLC",
                model_id: model_llama_3_1,
                model_lib: _webLlm.modelLibURLPrefix + _webLlm.modelVersion + "/Llama-3_1-8B-Instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm",
                overrides: {
    ...
    const inference_engine = await _webLlm.CreateMLCEngine(model_llama_3_1, {
        appConfig: appConfig,
...
},{"@mlc-ai/web-llm":"jkSFw"}]},["eZ0eC","221aX"], "221aX", "parcelRequire90c9")

//# sourceMappingURL=llama_8b.eaa4679b.js.map
