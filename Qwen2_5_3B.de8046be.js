...
})({"cM3ms":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "e1982e44de8046be";
"use strict";
...
},{}],"5Z2ge":[function(require,module,exports) {
...
async function main() {
    ...
    const model_qwen = "Qwen2.5-3B-Instruct-q4f32_1-MLC";
    const appConfig = {
        model_list: [
            {
                model: "https://huggingface.co/mlc-ai/Qwen2.5-3B-Instruct-q4f32_1-MLC",
                model_id: model_qwen,
                model_lib: _webLlm.modelLibURLPrefix + _webLlm.modelVersion + "/Qwen2.5-3B-Instruct-q4f32_1-ctx4k_cs1k-webgpu.wasm",
                overrides: {
...
},{"@mlc-ai/web-llm":"jkSFw"}]},["cM3ms","5Z2ge"], "5Z2ge", "parcelRequire90c9")

//# sourceMappingURL=Qwen2_5_3B.de8046be.js.map
