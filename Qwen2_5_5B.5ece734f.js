...
})({"ehVML":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "1fd9c9445ece734f";
"use strict";
...
},{}],"8ms3j":[function(require,module,exports) {
...
async function main() {
    ...
    const model_qwen = "Qwen2.5-0.5B-Instruct-q0f32-MLC";
    const appConfig = {
        model_list: [
            {
                model: "https://huggingface.co/mlc-ai/Qwen2.5-0.5B-Instruct-q0f32-MLC",
                model_id: model_qwen,
                model_lib: _webLlm.modelLibURLPrefix + _webLlm.modelVersion + "/Qwen2-0.5B-Instruct-q0f32-ctx4k_cs1k-webgpu.wasm",
                overrides: {
...
},{"@mlc-ai/web-llm":"jkSFw"}]},["ehVML","8ms3j"], "8ms3j", "parcelRequire90c9")

//# sourceMappingURL=Qwen2_5_5B.5ece734f.js.map
